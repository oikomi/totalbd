...
type WebTransactionClassifyDetails struct {
	TotalReqCount       int64
	TotalRespTime       float64
}

//type WebTransactionClassify map[string]WebTransactionClassifyDetails
...
type StatSummary struct {
	...
	//add for classify web transaction
	WebTransactionClassify map[string]*WebTransactionClassifyDetails
	...
	ServiceDiscoveryData    *service_discovery.ServiceDiscoveryData
}

func NewStatsSummary() *StatSummary {
	return &StatSummary {
		WebTransactionClassify : make(map[string]*WebTransactionClassifyDetails),
		Top5Slow  : make([]*Stat, 0),
		MysqlData : module.NewMysqlData(),
		MemcacheData : module.NewMemcacheData(),
		MongodbData  : module.NewMongodbData(),
		RedisData  : module.NewRedisData(),
